    ...
    >
      ...
      <Transition name="scale">
        ...
        >
          <!-- 헤더 -->
          <div
            class="sticky top-0 bg-gradient-to-r from-primary/10 to-primary/5 px-8 py-6 border-b border-border z-10"
          >
            ...
            <form @submit.prevent="handleRegister" class="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <p class="text-xs text-foreground/40 mt-1">JPG, PNG, GIF</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="relative">
                  <FileText
                    class="absolute left-3 top-3 w-5 h-5 text-foreground/40"
                  />
                  <textarea
                    id="register-bio"
  ...
  try {
    ...
    if (response.data.accessToken) {
      ...
      if (!user.profileImage) {
        user.profileImage =
          formData.value.profileImage || "/default-profile.svg";
      }
